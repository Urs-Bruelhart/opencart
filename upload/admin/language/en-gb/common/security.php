...
$_['text_security']    = 'It is very imporant that you move the storage directory outside of the web directory (e.g. public_html, www or htdocs). Additionally you can rename the folder too.';
$_['text_choose']      = 'Choose how to move the storage directory';
$_['text_automatic']   = 'Automatically Rename and Move';
